...
XI_GPO_MODE = { 
    ...
    "XI_GPO_FRAME_TRIGGER_WAIT": c_uint(6),    #OOutput is on while camera is ready for trigger
...
XI_TS_RST_SOURCE = { 
    ...
    "XI_TS_RST_SRC_SW": c_uint(19),    #TRIGGER to sensor rising edge is active
...
XI_TEMP_SELECTOR = { 
    ...
    "XI_TEMP_SENSOR_BOARD": c_uint(2),    #PCB as image sensor
    "XI_TEMP_INTERFACE_BOARD": c_uint(3),    #Interface board
...
XI_DP_PARAM_VALUE = { 
    ...
    "XI_DP_PARAM_VALUE_CHMUX_CMS": c_uint(4),    #Correlated Multiple Sampling
...
class XI_IMG(Structure):
    ...
    _fields_ = [
        ...
        ("tsSec",    DWORD),        #Seconds part of timestamp delivered by camera (at start of read-out phase). Typical range: 0-4294 sec. (see Note3)
        ("tsUSec",    DWORD),        #Micro-seconds part of timestamp delivered by camera (at start of read-out phase). Range 0-999999 us. (see Note3)
        ...
        ("exposure_sub_times_us",    DWORD*5),         #Array with five sub exposures times in microseconds used by XI_TRG_SEL_MULTIPLE_EXPOSURES or hardware controlled HDR        ("data_saturation",    DOUBLE),        #Pixel value of saturation
